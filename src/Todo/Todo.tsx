            ...
            <ul>
                <div className={s.item}>
                    <li>
                        ...
                        <h4>Strategy</h4>
                        <p>  Brand Strategy, Product Strategy, Research & Analysis, Service Design, Content Strategy</p>
                    </li>
                </div>
                <div className={s.item}>
                    <li>
                        ...
                        <h4>Research</h4>
                        <p>Qualitative Research, Quantitative Research, Heuristic Evaluation, Competitor Analysis, Usability Testing</p>
                    </li>
                </div>
                <div className={s.item}>
                    <li>
                ...
                <div className={s.item}>
                    <li>
                        ...
                        <h4>CEO Marketing</h4>
                        <p>We make tailor-made user acquisition to increase business growth for you to uncover all the potential opportunities!</p>
                    </li>
                </div>
                <div className={s.item}>
                    <li>
