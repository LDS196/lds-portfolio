...
const projects: Array<cardProjectType>=[
    {kind:'online store',title:'new pizza',technologies: ['react','css', 'sass', 'redux', 'html', 'figma'],id:'1'},
    ...
    {kind:'social media',title:'Hi Brother',technologies: ['react','css', 'sass', 'redux', 'html', 'figma'],id:'4'},
    {kind:'online store',title:'new pizza',technologies: ['react','css', 'sass', 'redux', 'html', 'figma'],id:'5'},
    {kind:'online store',title:'new pizza',technologies: ['react','css', 'sass', 'redux', 'html', 'figma'],id:'6'},
]
const Portfolio = () => {
